...
Study -> 서브 카테고리에 Algorithm, DataStructure, ETC 메뉴를 설정했다. 
[sangmin2ya](https://sangmin2ya.github.io/studylog/hydejack/HJ1/) 님 블로그를 참고하여 만들었다.
...
![alt text](<../../../assets/img/etc/Pasted image 20250512135835.png>)

???

<u>사이드바에 메뉴는 만들었는데 클릭을 하면 404 에러가 난다.
...
![alt text](<../../../assets/img/etc/Pasted image 20250512140506.png>)

서브메뉴는 폴더를 만들어서 그안에 넣어줬습니다.

![alt text](<../../../assets/img/etc/Pasted image 20250512141003.png>)
...
categoris : [study, etc]  서브메뉴 etc에 글이 잘 올라가는 것을 볼수 있다.

![alt text](<../../../assets/img/etc/Pasted image 20250512142836.png>)
